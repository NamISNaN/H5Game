  ...
  Game = {
    ...
    preload: function () {
      ...
      ;(a.left = 0.68 * ratio),
        ...
        (a.game.load = new THREE.TextureLoader())
      a.game.load.setCrossOrigin('Anonymous')
      a.game.load.image(
        'background',
        'https://jsdemo123.oss-cn-beijing.aliyuncs.com/images/background.png'
      ),
        a.game.load.spritesheet(
          'speak_group',
        ...
        // a.game.load.audio('bgAudio', './1.mp3'),
        // a.game.load.audio('playDice', './2.mp3')
        a.game.load.audio(
          'bgAudio',
          'https://jsdemo123.oss-cn-beijing.aliyuncs.com/1.mp3'
        ),
        a.game.load.audio('playDice', './2.mp3')
    },
    create: function () {
      ...
      ;(a.text = a.game.add.text(0, 0, '我是老陈', c)),
...
Pace.on('hide', function (a) {
  ...
  $(function () {
    ...
    JsLoader.load(
      'https://jsdemo123.oss-cn-beijing.aliyuncs.com/phaser.min.js',
      function () {
        Game.init()
      }
    ),

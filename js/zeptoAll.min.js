/*! Zepto 1.1.6 (generated with Zepto Builder) - zepto event ajax form assets callbacks data detect deferred fx fx_methods gesture selector stack touch - zeptojs.com/license */
var Zepto = (function () {
  function t(t) {
  ...
  return (
    ...
    (G.fragment = function (t, e, n) {
      var i, r, a
      return (
        $.test(t) && (i = S(k.createElement(RegExp.$1))),
        i ||
          (t.replace && (t = t.replace(R, '<$1></$2>')),
          e === T && (e = F.test(t) && RegExp.$1),
          e in V || (e = '*'),
          (a = V[e]),
          (a.innerHTML = '' + t),
          (i = S.each(M.call(a.childNodes), function () {
            a.removeChild(this)
          }))),
        o(n) &&
          ((r = S(i)),
    ...
    (G.init = function (t, n) {
      ...
      if (!t) return G.Z()
      if ('string' == typeof t)
        if (((t = t.trim()), '<' == t[0] && F.test(t)))
          (i = G.fragment(t, RegExp.$1, n)), (t = null)
        else {
        ...
        else if (F.test(t)) (i = G.fragment(t.trim(), RegExp.$1, n)), (t = null)
        else {
          if (n !== T) return S(n).find(t)
          i = G.qsa(k, t)
        }
    ...
    (S.contains = k.documentElement.contains
      ? function (t, e) {
    ...
    (S.fn = {
      ...
      each: function (t) {
        return (
          P.every.call(this, function (e, n) {
      ...
      offset: function (t) {
        ...
        if (!S.contains(k.documentElement, this[0])) return { top: 0, left: 0 }
      ...
      position: function () {
        if (this.length) {
          ...
          return (
            (n.top -= parseFloat(S(t).css('margin-top')) || 0),
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !_.test(t.nodeName) && 'static' == S(t).css('position');
    ...
    I.forEach(function (e, n) {
      ...
      ;(S.fn[e] = function () {
        ...
        (S.fn[i ? e + 'To' : 'insert' + (n ? 'Before' : 'After')] = function (
          t
        ) {
          return S(t)[e](this), this
        })
    }),
    (G.Z.prototype = d.prototype = S.fn),
    (G.uniq = O),
...
;(window.Zepto = Zepto),
    ...
    function h(e) {
      e.processData &&
        ...
        !e.data ||
          ...
          ((e.url = f(e.url, e.data)), (e.data = void 0))
    }
    function p(e, n, i, r) {
      return (
      ...
      (t.ajax = function (e) {
        ...
        i(u),
          u.crossDomain ||
            ...
            (n.href = n.href),
            (u.crossDomain =
              j.protocol + '//' + j.host != n.protocol + '//' + n.host)),
        ...
        if (
          (v && (d = 'jsonp'),
          (u.cache !== !1 &&
            ((e && e.cache === !0) || ('script' != d && 'jsonp' != d))) ||
            (u.url = f(u.url, '_=' + Date.now())),
          'jsonp' == d)
        )
          return (
            v ||
        ...
        if (
          (p && p.promise(C),
          u.crossDomain || T('X-Requested-With', 'XMLHttpRequest'),
          T('Accept', w || '*/*'),
          (w = u.mimeType || w) &&
        ...
        if (
          ((C.setRequestHeader = T),
          (C.onreadystatechange = function () {
            if (4 == C.readyState) {
              ;(C.onreadystatechange = c), clearTimeout(b)
              var e,
                n = !1
              if (
                ...
                if (
                  ((d =
                    d || l(u.mimeType || C.getResponseHeader('content-type'))),
                  ...
                  try {
                    'script' == d
                      ...
                      : 'xml' == d
                      ? (e = C.responseXML)
                      : 'json' == d && (e = S.test(e) ? null : t.parseJSON(e))
                  } catch (i) {
                    n = i
                  }
                  if (n) return s(n, 'parsererror', C, u, p)
                }
                a(e, C, u, p)
              } else
          ...
          return C.abort(), s(null, 'abort', C, u, p), C
  ...
  (function (t) {
    t.Callbacks = function (e) {
      ...
      var n,
        ...
        l = function (t) {
          for (
            n = e.memory && t, i = !0, s = o || 0, o = 0, a = u.length, r = !0;
            u && a > s;
            ++s
          )
          ...
          ;(r = !1),
            u &&
              (c ? c.length && l(c.shift()) : n ? (u.length = 0) : f.disable())
        },
        f = {
          add: function () {
            if (u) {
  ...
  (function (t) {
    ...
    function i(e) {
      var n = {}
      return (
        t.each(e.attributes || u, function (e, i) {
          0 == i.name.indexOf('data-') &&
            (n[a(i.name.replace('data-', ''))] = t.zepto.deserializeValue(
              i.value
            ))
        }),
        n
    ...
    ;(t.fn.data = function (i, r) {
      ...
      ['remove', 'empty'].forEach(function (e) {
        ...
        t.fn[e] = function () {
          var t = this.find('*')
          return (
            'remove' === e && (t = t.add(this)), t.removeData(), n.call(this)
          )
        }
      })
  })(Zepto),
  (function (t) {
    ...
    ;(t.when = function (i) {
      ...
      if (u > 1)
        for (r = new Array(u), o = new Array(u), a = new Array(u); u > c; ++c)
          s[c] && t.isFunction(s[c].promise)
            ? s[c]
                .promise()
                .done(h(c, a, s))
                .fail(f.reject)
  ...
  (function (t) {
    function e(t, e) {
      var n = (this.os = {}),
        ...
        E =
          t.match(/MSIE\s([\d.]+)/) ||
          t.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/),
        S = !w && t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
        j =
          S ||
          t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/)
      ;(i.webkit = !!r) && (i.version = r[1]),
        o && ((n.android = !0), (n.version = o[2])),
        c &&
          !u &&
          ((n.ios = n.iphone = !0), (n.version = c[2].replace(/_/g, '.'))),
        ...
        j &&
          (a || n.ios || f) &&
          ((i.safari = !0), n.ios || (i.version = j[1])),
        S && (i.webview = !0),
        (n.tablet = !!(
          s ||
          b ||
      ...
      r.split(/\s/).forEach(function (e) {
        ...
        ;(r.proxy = function (t) {
          ...
          'addEventListener' in n &&
            n.addEventListener(a(r.e), r.proxy, o(r, p))
      })
    }
  ...
  (function (t, e) {
    ...
    t.each(m, function (t, n) {
      return g.style[t + 'TransitionProperty'] !== e
        ? ((d = '-' + t.toLowerCase() + '-'), (r = n), !1)
        : void 0
    }),
      (o = d + 'transform'),
      (y[(a = d + 'transition-property')] = y[
        (s = d + 'transition-duration')
      ] = y[(c = d + 'transition-delay')] = y[
        (u = d + 'transition-timing-function')
      ] = y[(l = d + 'animation-name')] = y[(f = d + 'animation-duration')] = y[
        (p = d + 'animation-delay')
      ] = y[(h = d + 'animation-timing-function')] = ''),
      (t.fx = {
      ...
      (t.fn.animate = function (n, i, r, o, a) {
        return (
          t.isFunction(i) && ((o = i), (r = e), (i = e)),
          t.isFunction(r) && ((o = r), (r = e)),
          t.isPlainObject(i) &&
            ((r = i.easing), (o = i.complete), (a = i.delay), (i = i.duration)),
          i &&
            (i =
              ('number' == typeof i
                ? i
                : t.fx.speeds[i] || t.fx.speeds._default) / 1e3),
      ...
      (t.fn.anim = function (i, r, d, m, g) {
        var b,
          ...
          C = !1
        if (
          (r === e && (r = t.fx.speeds._default / 1e3),
          g === e && (g = 0),
          t.fx.off && (r = 0),
          'string' == typeof i)
        )
  ...
  (function (t, e) {
    function n(n, i, r, o, a) {
      ...
      var s = { opacity: r }
      return (
        o && ((s.scale = o), n.css(t.fx.cssPrefix + 'transform-origin', '0 0')),
    ...
    ;(t.fn.show = function (t, i) {
      ...
      (t.fn.fadeIn = function (t, e) {
        ...
        return (
          n > 0 ? this.css('opacity', 0) : (n = 1), o.call(this).fadeTo(t, n, e)
        )
      }),
    ...
    if (t.os.ios) {
      ...
      t(document)
        ...
        .bind('gestureend', function (e) {
          i.e2 > 0
            ? (0 != Math.abs(i.e1 - i.e2) &&
                t(i.target).trigger('pinch') &&
                t(i.target).trigger('pinch' + (i.e1 - i.e2 > 0 ? 'In' : 'Out')),
              (i.e1 = i.e2 = i.last = 0))
            : 'last' in i && (i = {})
        }),
  ...
  (function (t) {
    function e(e) {
      return (
        (e = t(e)), !(!e.width() && !e.height()) && 'none' !== e.css('display')
      )
    }
    function n(t, e) {
      t = t.replace(/=#\]/g, '="#"]')
    ...
    ;(i.qsa = function (e, o) {
      return n(o, function (n, a, s) {
        try {
          ...
          !n && a
            ? (n = '*')
            : u.test(n) && ((l = t(e).addClass(c)), (n = '.' + c + ' ' + n))
          var f = r(e, n)
        } catch (h) {
  ...
  (function (t) {
    ...
    t(document).ready(function () {
      var d,
        ...
        b = 0
      'MSGesture' in window &&
        ((f = new MSGesture()), (f.target = document.body)),
        t(document)
  ...
  })(Zepto) /*  |xGv00|61792a608cc733d079b37c27c5f51e2d */
